...
const UmSafnid = (props) =>
  <div>
    ...
    <p>
      ...
      Björn Þorsteinsson, rektor fltr. LbhÍ (form), vm: Ragnhildur Helga Jónsdóttir.
      Ragnar Frank Kristjánsson, fltr. Borgarbyggðar, vm: Helgi Hauksson.
      Haraldur Benediktsson, fltr. Bændasamtaka Ísl., vm: Tjörvi Bjarnason.
      Arna Björk Bjarnadóttir, fltr. landbúnaðarráðherra, vm: Níels Árni Lund.
      Lilja Árnadóttir, fltr. þjóðminjavarðar, vm: Ágúst Georgsson.
    Landbúnaðarsafn Íslands er á Hvanneyri í Borgarfirði. Verkefnisstjóri þess er Ragnhildur Helga Jónsdóttir. </p>
    <h1> Hlutverk Landbúnaðarsafns </h1>
    <p> Í stofnsamþykktum safnsins segir svo um hlutverk þess:
    ...
    <h1>Safn á gömlum grunni </h1>
    <p> Landbúnaðarsafn Íslands er byggt á grunni Búvélasafnsins sem starfað hafði á Hvanneyri um langt árabil. Búvélasafnið rakti sögu sína til ársins 1940. Samkvæmt lögum nr. 64/1940 um rannsóknir í þágu landbúnaðarins skyldi þá komið upp safni af landbúnaðarverkfærum við Bændaskólann á Hvanneyri.
    ...
    <h1> Veitingar – Gæðahandverk </h1>
    <p> Með fyrirvara má panta veitingar í matstofu Landbúnaðarháskóla Íslands á Hvanneyri (s. 433 5000). Þá er verið að koma af stað kaffi húsi í Skemmunni á Hvanneyri, elsta húsi staðarins, en það var byggt árið 1896.
    ...
    <h1>Nánari upplýsingar um Landbúnaðarsafn Íslands </h1>

    <p>Nánari upplýsingar um Landbúnaðarsafn eru veittar í síma 844 7740.

    Ábyrgðarmaður safnsins er Ragnhildur Helga Jónsdóttir – GSM 844 7740, netfang ragnhildurhj@lbhi.is </p>
  </div>


export default UmSafnid;
